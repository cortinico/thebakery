...
header:
  ...
  overlay_filter: "0.6"
  og_image: "/assets/images/episodes/23-og.png"
...
It's been since [episode #07](https://thebakery.dev/07) that we haven't talked about Flutter 💙, so today we have [**Miguel Beltran**](https://twitter.com/MiBLT) on stage to talk about one of the most important library for it: [**Plus Plugins**](https://github.com/fluttercommunity/plus_plugins).
